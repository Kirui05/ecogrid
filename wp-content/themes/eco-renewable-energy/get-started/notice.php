        		...
        		<div class="notice-content">
	        		<div class="notice-holder">
	                        ...
	                        <a href="javascript:void(0);" id="install-activate-button" class="button admin-button info-button">
							   <?php echo __('Getting started', 'eco-renewable-energy'); ?>
							</a>

							<script type="text/javascript">
							document.getElementById('install-activate-button').addEventListener('click', function () {
							    const eco_renewable_energy_button = this;
							    const eco_renewable_energy_redirectUrl = '<?php echo esc_url(admin_url("themes.php?page=eco-renewable-energy")); ?>';
	                        ...
	                        <a href="<?php echo esc_url( ECO_RENEWABLE_ENERGY_DOC_URL ); ?>" target="_blank" id="doc-button" class="button admin-button bundle-button"><?php echo __('Free Documentation', 'eco-renewable-energy'); ?></a>
	            	</div>
	            </div>
