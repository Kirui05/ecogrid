 ...
 * Footer Default
 * 
 * slug: eco-renewable-energy/footer-default
 * title: Footer Default
 * categories: eco-renewable-energy
 */

return array(
    'title'      =>__( 'Footer Default', 'eco-renewable-energy' ),
    ...
    <div class="wp-block-group has-background-color has-text-color has-background has-link-color" style="background-color:#101010"><!-- wp:columns {"className":"alignwide","style":{"spacing":{"padding":{"top":"35px","bottom":"35px","right":"0px","left":"0px"},"blockGap":{"top":"0","left":"0"},"margin":{"top":"0","bottom":"0"}}}} -->
        ...
        <h2 class="wp-block-heading has-background-color has-text-color has-lato-font-family" style="font-size:22px;font-style:normal;font-weight:600">'. esc_html__('About Us','eco-renewable-energy') .'</h2>
        <!-- /wp:heading -->
        
        <!-- wp:paragraph {"fontSize":"medium","fontFamily":"inter"} -->
        <p class="has-lato-font-family has-medium-font-size">'. esc_html__('Lorem Ipsum is simply dummy text of the printing and typesetting industry.','eco-renewable-energy') .'</p>
        <!-- /wp:paragraph -->
        ...
        <h2 class="wp-block-heading has-background-color has-text-color has-lato-font-family" style="font-size:22px;font-style:normal;font-weight:600">'. esc_html__('Services','eco-renewable-energy') .'</h2>
        <!-- /wp:heading -->
        ...
        <!-- wp:navigation-link {"label":"Residential Solar Solutions","type":"","url":"#","kind":"custom","isTopLevelLink":true} /-->
        
        <!-- wp:navigation-link {"label":"Commercial Solar Installations","type":"","url":"#","kind":"custom","isTopLevelLink":true} /-->
        
        <!-- wp:navigation-link {"label":"Solar Panel Maintenance","type":"","url":"#","kind":"custom","isTopLevelLink":true} /-->
    
        <!-- wp:navigation-link {"label":"Energy Storage Solutions","type":"","url":"#","kind":"custom","isTopLevelLink":true} /-->
        <!-- /wp:navigation --></div>
        <!-- /wp:column -->
        ...
        <h2 class="wp-block-heading has-background-color has-text-color has-lato-font-family" style="font-size:22px;font-style:normal;font-weight:600">'. esc_html__('Resources','eco-renewable-energy') .'</h2>
        <!-- /wp:heading -->
        
        <!-- wp:navigation {"textColor":"#E1E1E1","overlayMenu":"never","className":"is-head-menu","style":{"typography":{"fontStyle":"normal","fontWeight":"400"}},"fontFamily":"inter","layout":{"type":"flex","justifyContent":"left","orientation":"vertical"}} -->
        <!-- wp:navigation-link {"label":"Solar Energy FAQs","type":"","url":"#","kind":"custom","isTopLevelLink":true} /-->
        ...
        <!-- wp:navigation-link {"label":"Video Tutorials","type":"","url":"#","kind":"custom","isTopLevelLink":true} /-->
        <!-- /wp:navigation --></div>
        <!-- /wp:column -->
        ...
        <h2 class="wp-block-heading has-background-color has-text-color has-lato-font-family" style="font-size:22px;font-style:normal;font-weight:600">'. esc_html__('Contact Us','eco-renewable-energy') .'</h2>
        <!-- /wp:heading -->
        ...
        <p class="has-text-align-left has-background-color has-text-color has-link-color has-inter-font-family has-medium-font-size has-lato-font-family" style="font-style:normal;font-weight:400"><span class="dashicons dashicons-email-alt"></span> '. esc_html__('support@example.com','eco-renewable-energy') .'</p>
        <!-- /wp:paragraph -->
        ...
        <p class="has-link-color has-inter-font-family has-background-color has-text-color has-lato-font-family has-medium-font-size" style="font-style:normal;font-weight:500"><span class="dashicons dashicons-phone"></span> '. esc_html__('+123 456 7890','eco-renewable-energy') .'</p>
        <!-- /wp:paragraph -->
        ...
        <p class="has-background-color has-text-color has-link-color has-inter-font-family has-medium-font-size has-lato-font-family" style="font-style:normal;font-weight:500"><span class="dashicons dashicons-admin-home"></span> '. esc_html__('123, Red Hills, Chicago,IL, USA','eco-renewable-energy') .'</p>
        <!-- /wp:paragraph --></div>
        <!-- /wp:column --></div>
        <!-- /wp:columns --></div>
        <!-- /wp:group -->
        
        <!-- wp:group {"className":"copyright-text","style":{"color":{"background":"var(--wp--preset--color--accent)"}},"layout":{"type":"constrained","contentSize":"80%"}} -->
        ...
        <p class="has-text-align-center has-background-color has-text-color has-link-color has-inter-font-family has-medium-font-size has-lato-font-family"><a href="https://www.wpradiant.net/products/free-renewable-energy-wordpress-theme">'. esc_html__('Renewable Energy WordPress Theme ','eco-renewable-energy') .'</a>'. esc_html__(' By ','eco-renewable-energy').'<a href="https://www.wpradiant.net/">'. esc_html__('WP Radiant','eco-renewable-energy') .'</a> |'. esc_html__('Proudly powered by','eco-renewable-energy') .' <a href="https://wordpress.org/">  '. esc_html__('WordPress','eco-renewable-energy') .'</a></p>
        <!-- /wp:paragraph --></div>
        <!-- /wp:column --></div>
        <!-- /wp:columns --></div>
        <!-- /wp:group -->
