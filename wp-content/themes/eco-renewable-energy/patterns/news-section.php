 ...
 * News Section
 * 
 * slug: eco-renewable-energy/news-section
 * title: News Section
 * categories: eco-renewable-energy
 */

    return array(
        'title'      =>__( 'News Section', 'eco-renewable-energy' ),
    ...
    <div id="blog" class="wp-block-group news-section wow bounceIn" style="padding-top:0;padding-bottom:0"><!-- wp:paragraph {"align":"center","style":{"elements":{"link":{"color":{"text":"var:preset|color|accent"}}},"typography":{"fontStyle":"normal","fontWeight":"600"}},"textColor":"accent","fontSize":"medium","fontFamily":"outfit"} -->
    <p class="has-text-align-center has-accent-color has-text-color has-link-color has-outfit-font-family has-medium-font-size" style="font-style:normal;font-weight:600">'. esc_html__('News & Blogs','eco-renewable-energy').'</p>
    <!-- /wp:paragraph -->

    <!-- wp:heading {"textAlign":"center","style":{"typography":{"fontStyle":"normal","fontWeight":"800","fontSize":"26px"},"elements":{"link":{"color":{"text":"var:preset|color|primary"}}}},"textColor":"primary","fontFamily":"outfit"} -->
    <h2 class="wp-block-heading has-text-align-center has-primary-color has-text-color has-link-color has-outfit-font-family" style="font-size:26px;font-style:normal;font-weight:800">'. esc_html__('Our Latest News & blogs','eco-renewable-energy').'</h2>
    <!-- /wp:heading -->
